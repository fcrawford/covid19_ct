...
source("../functions/model_vac.R")
source("../functions/run_ct_model_vac.R")
source("../functions/plot_functions.R")

## simulate model projections through this date
mydaymax              = ymd("2021-06-30") 
...
vacfun = get_vac_fun(mydayseq, VAC)
...
connecticut_summary_hosp1 = plot_ct_region(data=res1$summary, 
                                             ...
                                             ymax=3000,
                                             add.cong = TRUE)
#points(DAT_CT_STATE$time[(nrow(DAT_CT_STATE)-7):nrow(DAT_CT_STATE)], DAT_CT_STATE$cur_hosp[(nrow(DAT_CT_STATE)-7):nrow(DAT_CT_STATE)], col='black')
...
connecticut_summary_deaths1 = plot_ct_region(data=res1$summary, 
                                             ...
                                             avg='mean',
                                             add.cong = TRUE)
#points(DAT_CT_STATE$time[(nrow(DAT_CT_STATE)-7):nrow(DAT_CT_STATE)], DAT_CT_STATE$total_deaths[(nrow(DAT_CT_STATE)-7):nrow(DAT_CT_STATE)], col='black')
