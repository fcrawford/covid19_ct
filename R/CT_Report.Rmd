...
mapplot_ct_region(data = sir_results_summary, which.plot="rD", label="Cumulative\nDeaths", palette="Reds", ncol=4)
mapplot_ct_region(data = sir_results_summary, which.plot="cum_modH",  label="Cumulative\nHospitalizations", palette="Blues", ncol=4)  
```
...
```{r echo=FALSE}
connecticut_summary_deaths = plot_ct_region(data = sir_results_summary, region_name="Connecticut", which.plot="rD")
```
...
```{r echo=FALSE}
connecticut_summary_hospitalization = plot_ct_region(data = sir_results_summary, region_name="Connecticut", which.plot="rHsum")
```
...
```{r echo=FALSE}
fairfield_summary_deaths = plot_ct_region(data = sir_results_summary, region_name="Fairfield", which.plot="rD")
```

`r fairfield_summary_deaths`

```{r echo=FALSE}
fairfield_summary_hospitalization = plot_ct_region(data = sir_results_summary, region_name="Fairfield", which.plot="rHsum")
```
...
```{r echo=FALSE}
new_london_summary_deaths = plot_ct_region(data = sir_results_summary, region_name="New London", which.plot="rD")
```
`r new_london_summary_deaths`

```{r echo=FALSE}
new_london_summary_hospitalization = plot_ct_region(data = sir_results_summary, region_name="New London", which.plot="rHsum")
```
...
## Litchfield
```{r echo=FALSE}
litchfield_summary_deaths = plot_ct_region(data = sir_results_summary, region_name="Litchfield", which.plot="rD")
```
`r litchfield_summary_deaths`

```{r echo=FALSE}
litchfield_summary_hospitalization = plot_ct_region(data = sir_results_summary, region_name="Litchfield", which.plot="rHsum")
```
...
## Windham
```{r echo=FALSE}
windham_summary_deaths = plot_ct_region(data = sir_results_summary, region_name="Windham", which.plot="rD")
```
`r windham_summary_deaths`

```{r echo=FALSE}
windham_summary_hospitalization = plot_ct_region(data = sir_results_summary, region_name="Windham", which.plot="rHsum")
```
...
## Tolland
```{r echo=FALSE}
tolland_summary_deaths = plot_ct_region(data = sir_results_summary, region_name="Tolland", which.plot="rD")
```
`r tolland_summary_deaths`

```{r echo=FALSE}
tolland_summary_hospitalization = plot_ct_region(data = sir_results_summary, region_name="Tolland", which.plot="rHsum")
```
...
## Hartford
```{r echo=FALSE}
hartford_summary_deaths = plot_ct_region(data = sir_results_summary, region_name="Hartford", which.plot="rD")
```
`r hartford_summary_deaths`

```{r echo=FALSE}
hartford_summary_hospitalization = plot_ct_region(data = sir_results_summary, region_name="Hartford", which.plot="rHsum")
```
...
## Middlesex
```{r echo=FALSE}
middlesex_summary_deaths = plot_ct_region(data = sir_results_summary, region_name="Middlesex", which.plot="rD")
```
`r middlesex_summary_deaths`

```{r echo=FALSE}
middlesex_summary_hospitalization = plot_ct_region(data = sir_results_summary, region_name="Middlesex", which.plot="rHsum")
```
...
```{r echo=FALSE}
new_haven_summary_deaths = plot_ct_region(data = sir_results_summary, region_name="New Haven", which.plot="rD")
```
`r new_haven_summary_deaths`

```{r echo=FALSE}
new_haven_summary_hospitalizations = plot_ct_region(data = sir_results_summary, region_name="New Haven", which.plot="rHsum")
```
