...
```{r echo=FALSE}
connecticut_summary_hospitalization = plot_ct_region("Connecticut", which.plot="H", add=dat_ct_capacity)
```
...
```{r echo=FALSE}
fairfield_summary_deaths = plot_ct_region("Fairfield", which.plot="D")
```

`r fairfield_summary_deaths`

```{r echo=FALSE}
fairfield_summary_hospitalization = plot_ct_region("Fairfield", which.plot="H")
```
...
```{r echo=FALSE}
new_london_summary_deaths = plot_ct_region("New London", which.plot="D")
```
`r new_london_summary_deaths`

```{r echo=FALSE}
new_london_summary_hospitalization = plot_ct_region("New London", which.plot="H")
```
...
## Litchfield
```{r echo=FALSE}
litchfield_summary_deaths = plot_ct_region("Litchfield", which.plot="D")
```
`r litchfield_summary_deaths`

```{r echo=FALSE}
litchfield_summary_hospitalization = plot_ct_region("Litchfield", which.plot="H")
```
...
## Windham
```{r echo=FALSE}
windham_summary_deaths = plot_ct_region("Windham", which.plot="D")
```
`r windham_summary_deaths`

```{r echo=FALSE}
windham_summary_hospitalization = plot_ct_region("Windham", which.plot="H")
```
...
## Tolland
```{r echo=FALSE}
tolland_summary_deaths = plot_ct_region("Tolland", which.plot="D")
```
`r tolland_summary_deaths`

```{r echo=FALSE}
tolland_summary_hospitalization = plot_ct_region("Tolland", which.plot="H")
```
...
## Hartford
```{r echo=FALSE}
hartford_summary_deaths = plot_ct_region("Hartford", which.plot="D")
```
`r hartford_summary_deaths`

```{r echo=FALSE}
hartford_summary_hospitalization = plot_ct_region("Hartford", which.plot="H")
```
...
## Middlesex
```{r echo=FALSE}
middlesex_summary_deaths = plot_ct_region("Middlesex", which.plot="D")
```
`r middlesex_summary_deaths`

```{r echo=FALSE}
middlesex_summary_hospitalization = plot_ct_region("Middlesex", which.plot="H")
```
...
```{r echo=FALSE}
new_haven_summary_deaths = plot_ct_region("New Haven", which.plot="D")
```
`r new_haven_summary_deaths`

```{r echo=FALSE}
new_haven_summary_hospitalizations = plot_ct_region("New Haven", which.plot="H")
```
