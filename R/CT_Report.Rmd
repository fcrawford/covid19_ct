...
# Projections 
We first show the projected cumulative deaths and hospitalizations for Connecticut counties over time. The projections are based on parameters calibrated on [...]. By the end of April, May, and June, we project `r get_Cumulative(c("2020-04-30","2020-05-31"), "rD.Connecticut")`, and `r get_Cumulative("2020-06-30", "rD.Connecticut")` deaths, and `r get_Cumulative(c("2020-04-30","2020-05-31"), "cum_modH.Connecticut")`; and `r get_Cumulative("2020-06-30", "cum_modH.Connecticut")` cumulative hospitalizations.
...
```
We then show the projected trajectories for the state and each counties. In addition to the main projection, 90% uncertainty intervals are also shown ...
[Describe sensitivity analysis, source of uncertainty coming from both parameter values and effect of lock down, acknowledge limitations?]
