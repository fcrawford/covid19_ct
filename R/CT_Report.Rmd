...
```{r echo=FALSE}
connecticut_summary_hospitalization = plot_ct_region("Connecticut", which.plot="rHsum")
```
...
```{r echo=FALSE}
fairfield_summary_hospitalization = plot_ct_region("Fairfield", which.plot="rHsum")
```
...
```{r echo=FALSE}
new_london_summary_hospitalization = plot_ct_region("New London", which.plot="rHsum")
```
...
```{r echo=FALSE}
litchfield_summary_hospitalization = plot_ct_region("Litchfield", which.plot="rHsum")
```
...
```{r echo=FALSE}
windham_summary_hospitalization = plot_ct_region("Windham", which.plot="rHsum")
```
...
```{r echo=FALSE}
tolland_summary_hospitalization = plot_ct_region("Tolland", which.plot="rHsum")
```
...
```{r echo=FALSE}
hartford_summary_hospitalization = plot_ct_region("Hartford", which.plot="rHsum")
```
...
```{r echo=FALSE}
middlesex_summary_hospitalization = plot_ct_region("Middlesex", which.plot="rHsum")
```
...
```{r echo=FALSE}
new_haven_summary_hospitalizations = plot_ct_region("New Haven", which.plot="rHsum")
```
