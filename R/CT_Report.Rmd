...
# Projections 
We first show the projected cumulative deaths and hospitalizations for Connecticut counties over time. The projections are based on parameters calibrated on [...]. By the end of April and May, we project `r get_Cumulative(c("2020-04-30","2020-05-31"), "rD.Connecticut")` deaths respectively; and `r get_Cumulative(c("2020-04-30","2020-05-31"), "cum_modH.Connecticut")` cumulative hospitalizations respectively.
