...
Probability of severe disease that requires hospitalization and may lead to death: \textbf{`r 1 - params_init$q_Im - params_init$q_A`}. 
...
Proportion of all infections (including asymptomatic) that end up hospitalized: \textbf{`r (1 - params_init$q_Im - params_init$q_A) * params_init$q_ins`}.

Probability of mild disease that does not require hospitalization and will lead to recovery: \textbf{`r params_init$q_Im`}. 
