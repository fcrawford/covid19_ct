...
Probability of severe disease that may lead to death among all infections: \textbf{`r round(1 - params_init$q_Im - params_init$q_A, 3)`}. 

Probability of severe disease among symptomatic patients: \textbf{`r round( (1 - params_init$q_Im - params_init$q_A) / (1 - params_init$q_A), 3)`}. 
